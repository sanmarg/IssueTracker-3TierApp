...
<meta charset="utf-8" />
<title>Issue Tracker | Admin Dashboard</title>
...
.tiles-body .heading a {
    color: #fff;
}

.tiles-body .progress-bar {
    background-color: #0F4C75;
}
...
.footer-widget .progress-bar {
    background-color: #3282B8;
}

.quick-section .dropdown-toggle {
    color: #fff;
}

.quick-section .dropdown-menu {
    background-color: #BBE1FA;
}

.quick-section .dropdown-menu > li > a {
    color: #1B262C;
}

.quick-section .dropdown-menu > li > a:hover {
    background-color: #BBE1FA;
}
