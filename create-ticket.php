...
<meta charset="utf-8" />
<title>Issue Tracker | Create  ticket</title>
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select  name="tasktype" class="form-control select" required>
                                                ...
                                                <option value="billing">PAAS</option>
                                                <option value="ot1">SAAS</option>
                                                <option value="ot2">IAAS</option>
                                                <option value="ot3">FAAS</option>
                                            </select>
                                           </div>
                                    </div>
