...
<style>
    ...
    .page-title h3, .control-label, a.active span, .page-content .breadcrumb li p, .page-content .breadcrumb li a , .semi-bold{
        color: #FFFFFF;
    }
    .panel-footer{
            ...
            <div class="grid-body  no-border" style="display:none">
              ...
              <div class="form-actions">
                <div class="post col-md-12">
                  <div class="user-profile-pic-wrapper">
                    <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="assets/img/admin.png"
                     data-src="assets/img/admin.png" src="assets/img/admin.png" alt="Admin"> </div>
                  </div>
                  <div class="info-wrapper">
