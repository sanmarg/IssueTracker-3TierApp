...
<meta charset="utf-8" />
<title>Issue Tracker | Request Quote</title>
...
<style>
    .page-content{
    background: hsla(210, 91%, 39%, 1); /* fallback for old browsers */
    ...
    .page-title, h3, .control-label, p ,.page-title p{
        color: #FFFFFF;
    }
    .panel-footer{
...
<label class="col-md-3 control-label">Service Required :</label>
    <div class="col-md-9">                                                                                                                                        
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="wdnd" value="Cloud" checked="checked"/> Cloud</label><br>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="seo" value="Devops" />Devops	</label><br>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="swd" value="Kubernetes Cluster" /> Kubernetes Cluster</label><br>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="fwd" value="Solution Architect" /> Solution Architect</label><br>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="whs" value="Hosting Services" /> Hosting</label><br>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="ed"  value="Infrastructure"/> Infrastructure</label><br>
                                                 <label class="check">
                                             <input type="checkbox" class="icheckbox" name="opi" value="Online Payment Integration" /> Online Payment Integration</label><br>
                                                 <label class="check">
                                             <input type="checkbox" class="icheckbox" name="dba" value="Lambda Function" /> Lambda Function related</label><br>
                                                 <label class="check">
                                             <input type="checkbox" class="icheckbox" name="nd" value="Scalling" /> Scalling</label>
                        ...
                        <input type="email" name="email" class="form-control" value="<?php echo $rw['email'];?>" readonly="true">                                            
                                            ...
                                            <div class="form-group">
                                             ...
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="smo" value="SMO (Cost Optimization)	" /> Cost Optimization		</label><br>
                                             <label class="check">
                                             ...
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="wta" value="Walk Through Tutorials" /> Walk Through Tutorials</label><br>
                                                 <label class="check">
                                             <input type="checkbox" class="icheckbox" name="ld" value="System Design" /> System Design</label><br>
                                                 <label class="check">
                                             <input type="checkbox" class="icheckbox" name="osc" value="Open Source Product" /> Open Source Product</label><br>
                                                 <label class="check">
